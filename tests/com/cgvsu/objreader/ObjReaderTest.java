...
class ObjReaderTest {
    ...
    public void testParseVertex01() {
        ...
        ThreeDimensionalVector result = ObjReader.parseVertex(wordsInLineWithoutToken, 5);
        ThreeDimensionalVector expectedResult = new ThreeDimensionalVector(1.01f, 1.02f, 1.03f);
    ...
    public void testParseVertex02() {
        ArrayList<String> wordsInLineWithoutToken = new ArrayList<>(Arrays.asList("1.01", "1.02", "1.03"));
        ThreeDimensionalVector result = ObjReader.parseVertex(wordsInLineWithoutToken, 5);
        ThreeDimensionalVector expectedResult = new ThreeDimensionalVector(1.01f, 1.02f, 1.10f);
    ...
    public void testParseTextureVertex01() {
        ...
        TwoDimensionalVector result = ObjReader.parseTextureVertex(wordsInLineWithoutToken, 5);
        TwoDimensionalVector expectedResult = new TwoDimensionalVector(1.01f, 1.02f);
        Assertions.assertTrue(result.equals(expectedResult));
    }
    ...
    public void testParseTextureVertex02() {
        ArrayList<String> wordsInLineWithoutToken = new ArrayList<>(Arrays.asList("1.01", "1.02"));
        TwoDimensionalVector result = ObjReader.parseTextureVertex(wordsInLineWithoutToken, 5);
        TwoDimensionalVector expectedResult = new TwoDimensionalVector(1.01f, 1.12f);
    ...
    public void testParseNormal01() {
        ArrayList<String> wordsInLineWithoutToken = new ArrayList<>(Arrays.asList("1.01", "1.02", "1.03"));
        ThreeDimensionalVector result = ObjReader.parseNormal(wordsInLineWithoutToken, 5);
        ThreeDimensionalVector expectedResult = new ThreeDimensionalVector(1.01f, 1.02f, 1.03f);
        Assertions.assertTrue(result.equals(expectedResult));
    }
